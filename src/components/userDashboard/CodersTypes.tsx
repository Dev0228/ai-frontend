    ...
    <Card className="bg-black border-gray-700 border-2">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          ...
          <div>
            <Button className="bg-blue-400 hover:bg-blue-500 text-black font-medium rounded mr-4">
              React
            </Button>
            <Button className="bg-green-400 hover:bg-green-500 text-black font-medium rounded">
              Jscript
            </Button>
          </div>
        </div>
